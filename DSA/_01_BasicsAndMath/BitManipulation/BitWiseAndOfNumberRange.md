...
public class BitWiseAndOfNumberRange {
    ...
    // SC=TC=O(1)
    // Mistake: I thought finding out the contiguous sequence of 1s is the answer
    //          instead of finding out the entire contiguous matching sequence (the common prefix)
